-- =============================================
-- Migration: Add Product Licensing for Fab.OS
...
-- 2. Create UserProductAccess table for tracking user access
...
-- 4. Create UserProductRoles table
...
-- 8. Add audit columns to track changes
